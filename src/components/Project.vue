...
const modals = ref([
  {
    ...
    image: "http://localhost:5173/src/assets/images/project1.png",
    icon: [
      // Icon yang digunakan adalah Font Awesome
      // https://fontawesome
  ...
  },
  {
    ...
    image: "http://localhost:5173/src/assets/images/project-3.png",
    icon: [
      // Icon yang digunakan adalah Font Awesome
      // https://fontawesome
      "fa-brands fa-laravel",
...
<template>
    ...
    <div class="container mx-auto w-full" id="projects">
      <div class="text-center mb-15">
        ...
        <p class="text-center text-slate-500">
          Some Collections of My Projects
        </p>
      </div>
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-10">
        <div
          ...
          :key="modal.id" :class="'w-fit h-fit group transition-all overflow-hidden relative rounded-lg mx-3 md:mx-0 '+modal.background "
        >
          <div
            class="scale-85 translate-y-8 transition-all group-hover:scale-100 group-hover:translate-y-0 w-fit h-fit ease-in-out duration-600"
          >
  ...
  <div v-for="modal in modals" :key="modal.id">
    <div
      v-if="modal.isOpen"
      class="fixed inset-0 z-50 flex items-center justify-center bg-slate-500/50"
    >
