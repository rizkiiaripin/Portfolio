...
<template>
  ...
  <div class="flex">
    <aside
      ...
      :class="[
        is_open
          ? 'fixed top-0 left-0 z-40 w-64 h-screen transition-transform  sm:translate-x-0 -translate-x-0'
          : 'sm:static fixed top-0 left-0 z-40 w-64 h-screen transition-transform  sm:translate-x-0 -translate-x-full',
      ]"
    >
