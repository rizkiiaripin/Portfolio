    ...
    <div class="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
        <div class="md:flex md:justify-between">
          ...
          <div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-2">
              <div>
                  <h2 class="mb-6 text-lg font-semibold text-gray-900  dark:text-white">Quick Links</h2>
                  <ul class="text-gray-500 dark:text-gray-400 font-medium">
                      <li class="mb-4">
                          <a href="https://flowbite.com/" class="hover:underline">About Me</a>
                      </li>
                      <li class="mb-4">
                          <a href="https://tailwindcss.com/" class="hover:underline">My Projects</a>
                      </li>
                      <li class="mb-4">
      ...
      <div class="sm:flex sm:items-center sm:justify-between font-semibold text-md">
          <span class=" text-gray-500 sm:text-center dark:text-gray-400">© 2025 . It's <a href="https://flowbite.com/" class="hover:underline text-cyan-700">open source</a>
          </span>
