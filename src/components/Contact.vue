...
<template>
  <div
    ...
    :class="[
      isSubmitted
        ? 'fixed flex top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-full max-h-full overflow-y-auto overflow-x-hidden bg-slate-500/50'
        : 'hidden',
    ]"
  >
    <div class="relative p-4 w-full max-w-md max-h-full">
      <div class="relative bg-white rounded-lg shadow-sm dark:bg-gray-700">
        ...
        <div class="p-4 md:p-5 text-center">
          <svg
            :class="[
              'mx-auto mb-4 w-12 h-12 dark:text-gray-200',
              error
